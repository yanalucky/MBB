...
//NSString *const kLoginUserAgreementtype = @"agreementtype";
...
//NSString *const kLoginUserAgreementlimit = @"agreementlimit";
...
//NSString *const kLoginUserAgreementstartage = @"agreementstartage";
...
//NSString *const kLoginUserAgreementstart = @"agreementstart";
...
//            self.agreementtype = [self objectOrNilForKey:kLoginUserAgreementtype fromDictionary:dict];
...
//            self.agreementlimit = [self objectOrNilForKey:kLoginUserAgreementlimit fromDictionary:dict];
...
//            self.agreementstartage = [self objectOrNilForKey:kLoginUserAgreementstartage fromDictionary:dict];
...
//            self.agreementstart = [self objectOrNilForKey:kLoginUserAgreementstart fromDictionary:dict];
...
//    [mutableDict setValue:self.agreementtype forKey:kLoginUserAgreementtype];
...
//    [mutableDict setValue:self.agreementlimit forKey:kLoginUserAgreementlimit];
...
//    [mutableDict setValue:self.agreementstartage forKey:kLoginUserAgreementstartage];
...
//    [mutableDict setValue:self.agreementstart forKey:kLoginUserAgreementstart];
...
//    self.agreementtype = [aDecoder decodeObjectForKey:kLoginUserAgreementtype];
...
//    self.agreementlimit = [aDecoder decodeObjectForKey:kLoginUserAgreementlimit];
...
//    self.agreementstartage = [aDecoder decodeObjectForKey:kLoginUserAgreementstartage];
...
//    self.agreementstart = [aDecoder decodeObjectForKey:kLoginUserAgreementstart];
...
//    [aCoder encodeObject:_agreementtype forKey:kLoginUserAgreementtype];
...
//    [aCoder encodeObject:_agreementlimit forKey:kLoginUserAgreementlimit];
...
//    [aCoder encodeObject:_agreementstartage forKey:kLoginUserAgreementstartage];
...
//    [aCoder encodeObject:_agreementstart forKey:kLoginUserAgreementstart];
