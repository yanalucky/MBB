//
//  ServerConfigFeatureListByAge.h
//
...
@interface ServerConfigFeatureListByAge : NSObject <NSCoding, NSCopying>

@property (nonatomic, strong) NSString *featureListByAgeIdentifier;
