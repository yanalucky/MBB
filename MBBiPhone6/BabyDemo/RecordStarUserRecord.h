...
@class RecordStarRecordHelp;

@interface RecordStarUserRecord : NSObject <NSCoding, NSCopying>
...
@property (nonatomic, strong) RecordStarRecordHelp *recordHelp;
