//
//  ShopCartKJAndHWGoodsMsg_IntetalCell.m
//  Fcgo
//
...
@implementation ShopCartKJAndHWGoodsMsg_IntetalCell
...
- (void)setupUI
{
    ...
    self.intetalLabel.textColor = UIFontRedColor;
    self.intetalLabel.font = [UIFont systemFontOfSize:12];
    
    [self.intetalLabel mas_makeConstraints:^(MASConstraintMaker *make) {
    ...
    [self.middleView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(weakSelf.goodsImg.mas_bottom).mas_offset(10);
...
//    }
    ...
    self.intetalLabel.text = model.note;
   ...
   self.goodsPrice.text = [NSString stringWithFormat:@"¥ %.2f",round([model.totalPriceYUAN floatValue]*100)/100];
    ...
    self.numberButton.maxValue = model.remain.intValue/model.f_number.intValue;
    //self.numberButton.decreaseBtn.backgroundColor = UISepratorLineColor;
    //self.numberButton.increaseBtn.backgroundColor = UISepratorLineColor;
