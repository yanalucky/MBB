//
//  Fcgo_RealNameNoImageTableCell.m
//  Fcgo
//
...
@interface Fcgo_RealNameNoImageTableCell ()
...
@implementation Fcgo_RealNameNoImageTableCell
...
- (void)setupUI
{
    ...
    [self.middleLineView mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.mas_equalTo(weakSelf.cardLabel.mas_bottom).mas_offset(16);
