...
- (void)uploadLivePhoto:(PHLivePhoto *)livePhotoAsset saveKey:(NSString *)saveKey extParams:(NSDictionary *)extParams {
    ...
    NSUInteger photoFileSize = (NSUInteger)[[NSFileManager defaultManager] attributesOfItemAtPath:PATH_PHOTO_FILE error:nil].fileSize;
    NSUInteger moveFileSize = (NSUInteger)[[NSFileManager defaultManager] attributesOfItemAtPath:PATH_MOVIE_FILE error:nil].fileSize;
