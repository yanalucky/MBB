...
- (void)open
{
    if (self.isNeedPerspective)
    {
        ...
        [UIView animateWithDuration:0.25f animations:^{
            ...
            [UIView animateWithDuration:0.25f animations:^{
                self.maskImageView.layer.transform = CATransform3DTranslate(t, 0, -20, self.offset_y);
            }];
        }];
   ...
   isNeedPerspective:(BOOL)isNeedPerspective
{
    ...
    if (self)
    {
        ...
        [self.closeControl addTarget:self action:@selector(close1) forControlEvents:UIControlEventTouchUpInside];
