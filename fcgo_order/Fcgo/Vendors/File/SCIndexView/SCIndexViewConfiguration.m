...
+ (instancetype)configurationWithIndexViewStyle:(SCIndexViewStyle)indexViewStyle
{
    ...
    switch (indexViewStyle) {
        ...
        {
            indicatorBackgroundColor = SCGetColor(200, 200, 200, 0.5);
            indicatorTextColor = UIFontRedColor;//[UIColor whiteColor];
    ...
    return [self configurationWithIndexViewStyle:indexViewStyle
                ...
                indexItemSelectedBackgroundColor:UIFontRedColor//SCGetColor(40, 170, 40, 1)
