...
static CGFloat const WSProgressHUDHeightEdgeOffset = 12;
...
- (void)showImage:(UIImage *)image status:(NSString *)title maskType: (WSProgressHUDMaskType)maskType maskWithout: (WSProgressHUDMaskWithoutType)withoutType
{
    ...
    self.timer = [NSTimer timerWithTimeInterval:2 target:self selector:@selector(dismiss) userInfo:nil repeats:NO];
...
- (void)addOverlayViewToWindow
{
    ...
    [WSProgressHUD setProgressHUDFont:[UIFont systemFontOfSize:14]];
}
...
//                    }
        ...
        case WSProgressHUDTypeImage: {
            ...
            if (self.imageView.image) {
                ...
                [self startIndicatorAnimation:NO];
                self.labelView.center = CGPointMake(hudCenterX , hudCenterY + 18);
                self.labelView.textAlignment = NSTextAlignmentCenter;
                self.imageView.center = CGPointMake(hudCenterX, 22);
            } else {
    ...
    switch (self.hudType) {
        ...
        case WSProgressHUDTypeImage: {
            ...
            if (self.imageView.image) {
                ...
                WSProgressHUDDefaultWidth = WSProgressHUDDefaultWidth < 85 ? 85 : WSProgressHUDDefaultWidth+10;
                
                WSProgressHUDDefaultHeight = WSProgressHUDDefaultHeight < 70 ? 70 : WSProgressHUDDefaultHeight+10;
...
//    CGFloat duration = MIN((CGFloat)string.length*0.07 + 0.5, 5.0);
//    if (duration < 1.0) {
//        duration = 1.5;
//    }
//    return duration;
...
- (UILabel *)labelView
{
    if (!_labelView) {
        ...
        if ([UIFont respondsToSelector:@selector(preferredFontForTextStyle:)]) {
            ...
            _labelView.font = [UIFont systemFontOfSize:11];
        }
...
- (UILabel *)shimmeringLabel {
    if (!_shimmeringLabel) {
        ...
        if ([UIFont respondsToSelector:@selector(preferredFontForTextStyle:)]) {
            ...
            _shimmeringLabel.font = [UIFont systemFontOfSize:11];
        }
